...
const features = [
  ...
  "Cola en tiempo real",
  "Pantalla de video personalizada",
  "Playlist de respaldo automatica",
  "Panel de administracion completo",
  "Datos y metricas de uso",
  "QR en pantalla y para imprimir",
          ...
          <div className="glass-card glow rounded-3xl p-8 md:p-10 border-primary/30 border-2">
            <div className="text-center mb-8">
              ...
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-5xl md:text-6xl font-extrabold text-foreground">$50.000</span>
