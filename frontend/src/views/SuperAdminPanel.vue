...
const filteredVenues = computed(() => {
  ...
  return venues.value.filter(v => {
    ...
    else if (filter.value === 'overdue') matchesIndicator = v.payment_status === 'overdue' || v.payment_status === 'suspended'
        ...
        <article v-for="venue in filteredVenues" :key="venue.id" class="venue-card" :class="{ inactive: !venue.active }">
          <div class="venue-card-header">
            ...
            <div class="card-badges">
              ...
              <span v-if="venue.payment_status === 'suspended'" class="payment-badge payment-suspended">Suspendido</span>
              <span v-else-if="venue.payment_status === 'overdue'" class="payment-badge payment-overdue">Vencido</span>
